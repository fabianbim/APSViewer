 ...
 * @export
 */
export const VersionsApiAxiosParamCreator = function (apsConfiguration) {
    return {
        /**
 ...
 * @export
 */
export const VersionsApiFp = function (sdkManager) {
...
export class VersionsApi extends BaseApi {
    ...
    createVersion(accessToken, projectId, xUserId, copyFrom, versionPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).createVersion(accessToken, projectId, xUserId, copyFrom, versionPayload, options);
    ...
    createVersionRelationshipsRef(accessToken, projectId, versionId, xUserId, relationshipRefsPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).createVersionRelationshipsRef(accessToken, projectId, versionId, xUserId, relationshipRefsPayload, options);
                const response = yield request(this.axios);
    ...
    getVersion(accessToken, projectId, versionId, xUserId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersion(accessToken, projectId, versionId, xUserId, options);
                const response = yield request(this.axios);
    ...
    getVersionDownloadFormats(accessToken, projectId, versionId, xUserId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersionDownloadFormats(accessToken, projectId, versionId, xUserId, options);
                const response = yield request(this.axios);
    ...
    getVersionDownloads(accessToken, projectId, versionId, xUserId, filterFormatFileType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersionDownloads(accessToken, projectId, versionId, xUserId, filterFormatFileType, options);
                const response = yield request(this.axios);
    ...
    getVersionItem(accessToken, projectId, versionId, xUserId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersionItem(accessToken, projectId, versionId, xUserId, options);
                const response = yield request(this.axios);
    ...
    getVersionRefs(accessToken, projectId, versionId, xUserId, filterType, filterId, filterExtensionType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersionRefs(accessToken, projectId, versionId, xUserId, filterType, filterId, filterExtensionType, options);
                const response = yield request(this.axios);
    ...
    getVersionRelationshipsLinks(accessToken, projectId, versionId, xUserId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersionRelationshipsLinks(accessToken, projectId, versionId, xUserId, options);
                const response = yield request(this.axios);
    ...
    getVersionRelationshipsRefs(accessToken, projectId, versionId, xUserId, filterType, filterId, filterRefType, filterDirection, filterExtensionType, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).getVersionRelationshipsRefs(accessToken, projectId, versionId, xUserId, filterType, filterId, filterRefType, filterDirection, filterExtensionType, options);
                const response = yield request(this.axios);
    ...
    patchVersion(accessToken, projectId, versionId, modifyVersionPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield VersionsApiFp(this.sdkManager).patchVersion(accessToken, projectId, versionId, modifyVersionPayload, options);
                const response = yield request(this.axios);
